...
- **ACP protocol** — JSON-RPC over stdio with tool call, thinking, permission auto-reply, and form elicitation support (currently presented through Discord; see [terminology](docs/domain-language.md))
